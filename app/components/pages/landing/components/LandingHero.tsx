    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <AnimatedElement
          ...
          duration="slow"
          delay={300}
          className="absolute top-32 right-[5%] lg:right-[10%] hidden md:block"
        >
          <div
            className="w-80 lg:w-96 bg-dark-800/80 backdrop-blur-xl rounded-2xl border border-white/10 shadow-2xl shadow-black/50 animate-float"
        ...
        <AnimatedElement
          ...
          duration="slow"
          delay={500}
          className="absolute top-48 left-[5%] lg:left-[8%] hidden lg:block"
        >
          <div
            className="w-52 bg-dark-800/80 backdrop-blur-xl rounded-2xl border border-white/10 shadow-xl animate-float"
        ...
        <AnimatedElement
          ...
          duration="slow"
          delay={700}
          className="absolute bottom-36 left-[10%] hidden md:block"
        >
          <div
            className="w-56 bg-dark-800/80 backdrop-blur-xl rounded-2xl border border-white/10 shadow-xl animate-float"
        ...
        >
          <div
            className="w-44 bg-dark-800/80 backdrop-blur-xl rounded-2xl border border-white/10 shadow-xl animate-float"
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
        {/* Badge */}
        <AnimatedElement animation="fade-down" duration="fast" delay={100}>
        ...
        {/* Main headline */}
        <AnimatedElement animation="fade-up" duration="normal" delay={200}>
        ...
        {/* Subheadline */}
        <AnimatedElement animation="fade-up" duration="normal" delay={350}>
          <p className="text-xl md:text-2xl text-gray-400 mb-10 max-w-3xl mx-auto leading-relaxed">
            AI-powered personal finance management with intelligent insights, flexible scheduling,
            and real-time cash flow projections.
          </p>
        </AnimatedElement>

        {/* CTA Buttons */}
        <AnimatedElement animation="fade-up" duration="normal" delay={500}>
        ...
        <AnimatedElement animation="fade-up" duration="slow" delay={650}>
